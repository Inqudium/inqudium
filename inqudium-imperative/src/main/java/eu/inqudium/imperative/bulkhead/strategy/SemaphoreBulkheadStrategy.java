...
public final class SemaphoreBulkheadStrategy implements TimedBulkheadStrategy {
     ...
     *
     * <p>This is the in-place adjustment used for live re-tuning of the permit limit on a
     * running semaphore strategy. Strategy-type changes (semaphore → CoDel, etc.) take a
     * different path: they go through the atomic hot-swap mechanism documented in ADR-032,
     * which gates the swap on zero in-flight calls — no drain coordination needed.
     *
