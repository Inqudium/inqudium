...
/**
 * Fluent sub-builder that produces an {@link AdaptiveInstantStrategyConfig}.
 *
 ...
 */
public final class AdaptiveInstantStrategyConfigBuilder {

    private LimitAlgorithm algorithm;

    AdaptiveInstantStrategyConfigBuilder() {
     ...
     * (last-writer-wins).
     */
    public AdaptiveInstantStrategyConfigBuilder aimd(Consumer<AimdAlgorithmBuilder> configurer) {
     ...
     * (last-writer-wins).
     */
    public AdaptiveInstantStrategyConfigBuilder vegas(Consumer<VegasAlgorithmBuilder> configurer) {
        Objects.requireNonNull(configurer, "configurer");
